...
y-coordinates don't matter and hence the x-coordinates of start 
...
arrows that can be shot. An arrow once shot keeps travelling up 
infinitely. The problem is to find the minimum number of arrows 
